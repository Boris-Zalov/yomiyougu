<script>
	...
	import { GridSolid, AdjustmentsVerticalSolid, HomeSolid } from "flowbite-svelte-icons";
	...
	const containerClass =
		"fixed bottom-0 left-0 z-50 w-full h-18 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600";
