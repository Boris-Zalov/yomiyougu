<script lang="ts">
	...
	import { ArrowLeftOutline, CloseCircleSolid, HeartSolid } from "flowbite-svelte-icons";
...
{:else if book}
	<div class="page-container p-4">
		...
		<div class="mb-6 flex items-center gap-3">
			<Button color="alternative" size="sm" onclick={handleCancel} class="shrink-0">
		...
		>
			...
			<div>
				...
				<RadioDropdown bind:value={readingStatus} options={readingStatusOptions} />
			</div>
			...
			{#if allCollections.length > 0}
				<div>
					...
					<div
						class="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 space-y-2 max-h-48 overflow-y-auto"
					>
			...
			<div>
				...
				<div class="flex items-center gap-3">
					...
					<span class="text-sm text-gray-700 dark:text-gray-300"
						>Sync reading progress for this book</span
					>
				</div>
			</div>
			...
			<div class="flex gap-3 pt-4">
				...
				<Button type="submit" color="primary" class="flex-1" disabled={isSaving}>
					{#if isSaving}
...
{:else}
	<div class="page-container p-4">
		<P class="text-center text-gray-500 dark:text-gray-400">Book not found</P>
	</div>
{/if}
