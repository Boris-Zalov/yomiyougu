 ...
 */
export async function setBookCollections(bookId: number, collectionIds: number[]): Promise<void> {
 ...
 */
export async function updateReadingProgress(bookId: number, currentPage: number): Promise<Book> {
